...
const {getRandomInt} = require('./utilities/random')
...
const AVERAGE_RAINFALL_PER_DAY = 4
...
class Weather {
    ...
    rainFall() {
        const likelihood = this.likelihoodOfRain()
        const chance = getRandomInt(0, 100)
        return chance <= likelihood ? AVERAGE_RAINFALL_PER_DAY * likelihood : 0
    }
}
